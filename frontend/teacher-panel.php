...
<head>
    ...
    <style>
        ...
        .sidebar-header { background: #0d1b2a; padding: 20px; text-align: center; border-bottom: 3px solid #4facfe; }
        .sidebar-header h5 { color: #fff; font-weight: 700; font-size: 1.3rem; margin: 0; }
        .sidebar-header small { color: #88c0d0; display: block; margin-top: 5px; font-size: 0.9rem; }
        ...
        .sidebar a:hover, .sidebar a.active { background: #4facfe; color: white; transform: translateX(5px); }
