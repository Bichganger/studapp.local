...
<main class="main-content">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form id="addLibraryForm" class="row g-3">
                ...
                <div class="col-md-3">
                    <input type="text" name="student" class="form-control" placeholder="Автор">
                </div>
                <div class="col-md-2">
    ...
    <div class="card">
        <div class="card-header">Работы в библиотеке</div>
        <div class="card-body">
...
function addLibraryItem() {
    ...
    form.reset();
    loadLibrary();
    Sync.showNotification('Работа добавлена!', 'success');
}
