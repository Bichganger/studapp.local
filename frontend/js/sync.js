// Единая синхронизация для всех ролей через localStorage
(function() {
    'use strict';
    ...
    function sendNotification(title, message, target, group = null) {
        const notification = {
            ...
            title: title,
            message: message,
            target: target, // 'all', 'students', 'teachers', 'group'
            group: group,
    ...
    // Автоматическое обновление при изменении localStorage в других вкладках
