...
<head>
    ...
    <title>StudApp - Настройки аккаунта</title>
    <!-- Bootstrap 5.3 -->
    ...
    <main class="main-content">
        <div class="container">
            <div class="page-header">
                <h1 class="display-6 fw-bold"><i class="bi bi-gear-wide-connected me-2 text-primary"></i>Настройки аккаунта</h1>
                <p class="text-muted">Управляйте вашим профилем и безопасностью</p>
            </div>

            <div class="row">
                <!-- Боковое меню настроек (опционально) -->
                <div class="col-md-3 mb-4">
                    <div class="card">
                        <div class="list-group list-group-flush">
                            <a href="#profile" class="list-group-item list-group-item-action active" data-bs-toggle="list">Профиль</a>
                            <a href="#security" class="list-group-item list-group-item-action" data-bs-toggle="list">Безопасность</a>
                            <a href="#avatar" class="list-group-item list-group-item-action" data-bs-toggle="list">Аватар</a>
                            <a href="#notifications" class="list-group-item list-group-item-action" data-bs-toggle="list">Уведомления</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-9">
                    <div class="tab-content">
                                ...
                                <div class="card-body">
                                    <form id="profileForm">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" value="Иван" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Фамилия</label>
                                            <input type="text" class="form-control" value="Иванов" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Группа</label>
                                            <input type="text" class="form-control" value="ИТ-321" readonly disabled>
                                            <small class="text-muted">Группу можно изменить только через учебный отдел</small>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Email</label>
                                            <input type="email" class="form-control" value="ivan.ivanov@student.ru" required>
                                        </div>
                        ...
                        <div class="tab-pane fade" id="security">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0"><i class="bi bi-shield-lock me-2"></i>Смена пароля</h5>
                                </div>
                                <div class="card-body">
                                    <form id="securityForm">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" class="form-control" required>
                                            <div class="form-text">Минимум 8 символов, буквы и цифры</div>
                                        </div>
                                        <div class="mb-3">
                        ...
                        <div class="tab-pane fade" id="avatar">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0"><i class="bi bi-image me-2"></i>Загрузка аватара</h5>
                                </div>
                                <div class="card-body text-center">
                                    <img src="https://i.pravatar.cc/150?img=7" alt="Current avatar" class="rounded-circle mb-3" width="120" height="120">
                                    <div>
                                        <label for="avatarUpload" class="btn btn-outline-primary">
                                            <i class="bi bi-upload me-1"></i>Загрузить новое фото
                                        </label>
                                        <input type="file" id="avatarUpload" accept="image/*" style="display: none;">
                                        <button class="btn btn-outline-danger ms-2"><i class="bi bi-trash"></i> Удалить</button>
                                    </div>
                                    <p class="text-muted small mt-3">Рекомендуемый размер: 500x500 пикселей, формат JPG или PNG.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-check form-switch mb-2">
                                        ...
                                        <label class="form-check-label" for="emailNotifications">Email-уведомления о новых оценках</label>
                                    </div>
                                    <div class="form-check form-switch mb-2">
                                        <input class="form-check-input" type="checkbox" id="pushNotifications" checked>
                                        <label class="form-check-label" for="pushNotifications">Push-уведомления о занятиях</label>
                                    </div>
                                    <div class="form-check form-switch mb-2">
                                        <input class="form-check-input" type="checkbox" id="deadlineNotifications" checked>
                                        <label class="form-check-label" for="deadlineNotifications">Напоминания о дедлайнах</label>
                                    </div>
                                    <hr>
    ...
    <script>
        ...
        document.getElementById('avatarUpload')?.addEventListener('change', function(e) {
            if (e.target.files && e.target.files[0]) {
                ...
                if (typeof StudApp !== 'undefined') {
                    StudApp.showNotification('Фото загружено (демонстрация)', 'success');
                }
            }
        });
        ...
        document.getElementById('profileForm')?.addEventListener('submit', function(e) {
            e.preventDefault();
            if (typeof StudApp !== 'undefined') {
                StudApp.showNotification('Изменения профиля сохранены', 'success');
            }
        });
        ...
        document.getElementById('securityForm')?.addEventListener('submit', function(e) {
            ...
            if (newPass !== confirmPass) {
                if (typeof StudApp !== 'undefined') {
                    StudApp.showNotification('Новые пароли не совпадают', 'error');
                }
                return;
            }
            if (typeof StudApp !== 'undefined') {
                StudApp.showNotification('Пароль успешно изменён', 'success');
            }
        });
    </script>
</body>
