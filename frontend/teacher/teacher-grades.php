...
<div class="sidebar">
    ...
    <nav class="mt-3">
        ...
        <a href="teacher-grades.php" class="active"><i class="bi bi-star me-2"></i>Оценки</a>
...
<main class="main-content">
    ...
    <button class="btn btn-success mb-3" onclick="addGrade()"><i class="bi bi-plus"></i> Добавить оценку</button>
    
    <div class="card">
        <div class="card-header"><h5 class="mb-0"><i class="bi bi-star"></i> Оценки</h5></div>
        <div class="card-body">
