...
<main class="main-content">
    ...
    <button class="btn btn-success mb-3" onclick="addSchedule()"><i class="bi bi-plus"></i> Добавить занятие</button>
    
    <div class="card">
        <div class="card-header"><h5 class="mb-0"><i class="bi bi-calendar"></i> Расписание</h5></div>
        <div class="card-body">
