...
<div class="sidebar">
    ...
    <nav class="mt-3">
        ...
        <a href="student-library.php" class="active"><i class="bi bi-journal me-2"></i>Библиотека</a>
...
<main class="main-content">
    ...
    <div class="card">
        <div class="card-header"><h5 class="mb-0"><i class="bi bi-journal"></i> Библиотека работ</h5></div>
        <div class="card-body">
