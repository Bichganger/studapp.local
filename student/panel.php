...
<head>
    ...
    <style>
        ...
        .welcome-card { background: var(--gradient-primary); color: var(--bg-dark); }
        .card-header { background: var(--gradient-primary); color: var(--bg-dark); }
        .table thead th { background: rgba(0, 230, 118, 0.1); color: var(--text-primary); }
        .btn-success { background: var(--gradient-primary); border: none; }
        .stat-card { background: var(--bg-card); border: 1px solid var(--border-color); color: var(--text-primary); }
    </style>
</head>
